...
<body>
    ...
    <div id="feedback">
    	<h3>Feedback</h3>
        <div id="feedBox" title="Tell us what you think">
			<form>
                <label for="fbTitle">Title:</label>
                <br />
                <input id="fbTitle" name="fbTitle" placeholder="Title" type="text"/>
                <br />
                <label for="fbMess">Description</label>
                <br />
                <textarea id="fbMess" name="fbMess"></textarea>
            </form>
    ...
    <div id="bottomOuter">
    	...
    	<div id="bottomInner">
        	...
        	<!-- Content Start -->
        	<div id="content">
            	<a id="delete" href="dashboard.php">
                    <div id="delResume">
                        (x)
                    </div>
                </a>
                ...
                <div  id="education">
                    ...
                    <div class="col1">
                        ...
                        <div class="manage">
							...
							if(mysql_num_rows($edQ)==0) echo '<div class="emptySideRow">Empty</div>';
							else{
							...
							echo '
								<div class="ed entry" data-t="education" data-i="'.$ed->id.'">
									...
									<div class="col3">
										...
										<div class="date">
											(<span class="editable" data-field="grad_date" data-type="dateC">'.$ed->grad_date.'</span>)
										</div>
                       ...
                       <!-- Education Sample Start -->
                        <div class="ed entry sample" data-t="education">
                            ...
                            <div class="col3">
                                ...
                                <div class="date">
                                    (<span class="editable" data-field="grad_date" data-type="dateC">Graduation Date</span>)
                                </div>
